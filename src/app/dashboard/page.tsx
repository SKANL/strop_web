...
export default function DashboardPage() {
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:grid md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
            ...
            <CardContent>
                <div className="text-2xl font-bold text-destructive">$145,000.00</div>
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
             ...
             <CardContent>
                <div className="text-2xl font-bold text-green-600">$850,000.00</div>
